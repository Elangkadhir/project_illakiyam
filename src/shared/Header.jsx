...
const Header = () => {
    ...
    return (
        <motion.div
            ...
            className={`h-[80px] sticky top-0 z-50 ${themes[theme]}  shadow-lg`}
        >
            <div className="flex items-center justify-between mx-auto w-[90%] h-full">
                ...
                <div className="relative">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-md rounded-lg "
                    >
                        Theme
                        <ChevronDown size={16} />
                    </button>
